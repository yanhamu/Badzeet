    ...
    public class SummaryController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(long accountId, int budgetId)
        {
            ...
            var normalPayments = await paymentRepository.GetPayments(new PaymentsFilter(
                ...
                interval.From,
                interval.To,
                type: Budget.Domain.Model.PaymentType.Normal));

            var pendingPayments = await paymentRepository.GetPayments(new PaymentsFilter(
                accountId,
                interval.From,
                interval.To,
                type: Budget.Domain.Model.PaymentType.Pending));
            ...
            if (remainingDays > 0)
            {
                remainingDailyBudget = totalBudget / remainingDays;
            }
        ...
        public class SummaryDto
        {
            ...
            public decimal RemainingBudget { get => Budget - Spend; }
